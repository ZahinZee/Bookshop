...
if (isset($_POST['checkout'])) {
  ...
  $full_address = mysqli_real_escape_string($conn, $_POST['address'] . ', ' . $_POST['city'] . ', ' . $_POST['country'] . ' - ' . $_POST['pincode']);
      ...
      //   }
        ...
        if (mysqli_num_rows($cart_query) > 0) {
          while ($cart_item = mysqli_fetch_assoc($cart_query)) {
            ...
            mysqli_query($conn, "INSERT INTO `orders`(user_id,id,address,city,country,pincode,book,quantity,unit_price,sub_total) VALUES('$user_id','$conn_oid','$address','$city','$country','$pincode','$cart_books','$quantity','$unit_price','$sub_total')") or die('query failed');
          }
        }
        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="email" name="number" placeholder="Enter your number">
              ...
              <div style="padding: 0px;" class="row">
                ...
                <div class="col-50">
                  ...
                  <input type="text" id="zip" name="pincode" placeholder="1216">
                </div>
              </div>
            </div>
